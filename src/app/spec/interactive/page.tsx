...
export default function InteractiveShowcase() {
  ...
  return (
    <Shell activePath="/spec/interactive">
      <div className="bg-grid">
        <PageHeader
          eyebrow="Interactive Specification"
          title="Aegis Interactive Showcase"
          description="Visual design specification, pipeline flow visualizer, database schema inspector, and implementation architecture for the SentinelDAST core platform."
          actions={
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 py-6">
          {/* Scroll Navigation */}
          <div className="sticky top-0 z-10 -mx-6 lg:-mx-10 px-6 lg:px-10 py-3 bg-zinc-950/80 backdrop-blur border-b border-zinc-800/80 flex items-center gap-1 overflow-x-auto scrollbar-none">
            {NAV_SECTIONS.map((s) => (
              <button
                key={s.id}
            ...
            <section id="overview" className="scroll-mt-24 space-y-6">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-relaxed text-zinc-400">
                  SentinelDAST implements a complete enterprise-grade SaaS architecture for legal, scope-controlled
