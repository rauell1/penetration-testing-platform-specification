    ...
    <Shell activePath="/">
      <div className="bg-grid">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 py-10 space-y-10">
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 text-sm text-zinc-300 leading-relaxed">
              <div>
                <p className="mb-3">
                ...
                <p className="mb-3">
                  The pages under <Link href="/dashboard" className="text-emerald-400 hover:underline">/dashboard</Link>,{" "}
                  <Link href="/targets" className="text-emerald-400 hover:underline">/targets</Link>,{" "}
                  <Link href="/scans" className="text-emerald-400 hover:underline">/scans</Link>,{" "}
                  <Link href="/findings" className="text-emerald-400 hover:underline">/findings</Link>{" "}
                  and <Link href="/audit" className="text-emerald-400 hover:underline">/audit</Link>{" "}
              ...
              <div>
                <p className="mb-3">
                  The <Link href="/spec" className="text-emerald-400 hover:underline">/spec</Link>{" "}
                ...
                <div className="flex flex-wrap gap-1.5 mt-3">
                  <Pill tone="emerald">Next.js App Router</Pill>
                  <Pill tone="emerald">Neon Postgres</Pill>
          ...
          >
            <ul className="grid md:grid-cols-2 gap-x-8 gap-y-2 text-sm text-zinc-300">
...
function Feature({
  ...
  return (
    <div
      className={`rounded-xl border ${border} bg-[#09090b]/60 p-5 backdrop-blur`}
    >
